...
**Harness:** Patterns inform specs and build; committed JSON must pass [`n8n-verify`](../n8n-verify/SKILL.md).

**RD SharePoint + PDF:** Before planning or building challenge-style flows, read [`docs/exemplos-patterns.md`](../../../docs/exemplos-patterns.md) (exo-1…exo-5) and optional `Exemplos.json`. Do not substitute HTTP PDF-read APIs for **Extract from File** `pdf`.
...
**[n8n-mcp-local](../n8n-mcp-local/SKILL.md)** — use to:
...
3. Use [n8n-mcp-local](../n8n-mcp-local/SKILL.md) to find nodes
4. Follow the workflow creation checklist
5. Use n8n Validation Expert to validate

**Related Skills**:
- [n8n-mcp-local](../n8n-mcp-local/SKILL.md) — find and configure nodes
