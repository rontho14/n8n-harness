...
**Harness:** Use with `workflows/<slug>.json` and specs. MCP tools are required in the pipeline when available; [`n8n-verify`](../n8n-verify/SKILL.md) is authoritative for spec alignment.
...
- [n8n-mcp-local](../n8n-mcp-local/SKILL.md) — use validation tools correctly
