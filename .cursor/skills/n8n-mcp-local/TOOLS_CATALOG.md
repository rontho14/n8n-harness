# n8n MCP (local) — tool catalog

Expert guide for using n8n-harness-mcp tools effectively. Read [SKILL.md](SKILL.md) and [docs/mcp-pipeline.md](../../../docs/mcp-pipeline.md) for harness pipeline requirements.
