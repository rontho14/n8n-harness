...
**Harness:** Code node logic in `workflows/<slug>.json`; prefer [`n8n-expression-syntax`](../n8n-expression-syntax/SKILL.md) for non-Code fields.
...
**[n8n-mcp-local](../n8n-mcp-local/SKILL.md)**:
