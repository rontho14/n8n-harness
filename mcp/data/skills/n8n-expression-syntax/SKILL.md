...
- SharePoint URLs: `encodeURIComponent('02 - Documentos Base')` or literal encoded segment in If `rightValue`; `decodeURIComponent($json.webUrl)` / `.split('/').pop()` for filenames — EXAMPLES ex16–ex18, `docs/n8n-node-catalog.md`
