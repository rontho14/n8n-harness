...
const SKILL_URI_PREFIX = 'skill://n8n-harness-mcp/';
...
export class SkillResourceRegistry {
  ...
  static getByUri(uri: string): SkillResource | null {
    ...
    // Accept bare skill://n8n-harness-mcp/{name} as alias for SKILL.md
    ...
    return [
      {
        ...
        name: 'n8n skill (main)',
        description: 'Primary SKILL.md document for an n8n-harness-mcp skill',
        mimeType: MIME_TYPE,
      },
      {
        uriTemplate: `${SKILL_URI_PREFIX}{name}/{file}`,
        name: 'n8n skill (supporting file)',
        description: 'A markdown file inside a specific n8n-harness-mcp skill',
        mimeType: MIME_TYPE,
      },
    ];
  }
