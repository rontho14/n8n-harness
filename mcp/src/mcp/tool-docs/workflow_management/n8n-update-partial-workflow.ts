...
- Simplifying node configuration`,
    ...
    examples: [
      ...
      '// Multiple sequential patches\nn8n_update_partial_workflow({id: "pnf3", operations: [{type: "patchNodeField", nodeName: "Set Email", fieldPath: "parameters.assignments.assignments.6.value", patches: [{find: "© 2025 n8n-harness-mcp", replace: "© 2026 n8n-harness-mcp"}, {find: "<p>Unsubscribe</p>", replace: ""}]}]})',
