#!/usr/bin/env node
/**
 * Test script for URL configuration in n8n-harness-mcp HTTP server
...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    env: {
      ...
      AUTH_TOKEN: 'test-token-for-testing-only',
      PORT: '3002',
      BASE_URL: 'https://n8n-harness-mcp.example.com'
    },
    expectedUrls: {
      health: 'https://n8n-harness-mcp.example.com/health',
      mcp: 'https://n8n-harness-mcp.example.com/mcp'
    }
  },
  {
  ...
  },
  {
    ...
    // See: mcp/THIRD_PARTY.md (upstream)
...
async function main() {
  console.log('🚀 n8n-harness-mcp URL Configuration Test Suite');
  console.log('======================================');
