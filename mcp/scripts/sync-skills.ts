 ...
 * data/skills/ so they ship inside the n8n-harness-mcp npm/Docker artifacts.
 *
...
async function main(): Promise<void> {
  ...
  if (!existsSync(SOURCE)) {
    ...
    console.error('Set N8N_SKILLS_SOURCE or clone n8n-skills next to n8n-harness-mcp.');
    process.exit(1);
  }
