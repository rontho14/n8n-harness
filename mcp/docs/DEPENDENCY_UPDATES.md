...
This guide explains how n8n-harness-mcp keeps its n8n dependencies up to date with the weekly n8n release cycle.

## 🔄 Overview

n8n releases new versions weekly, typically on Wednesdays. To ensure n8n-harness-mcp stays compatible and includes the latest nodes, we've implemented automated dependency update systems.
