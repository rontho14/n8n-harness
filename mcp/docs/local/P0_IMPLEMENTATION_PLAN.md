...
## Critical Fixes for n8n-harness-mcp Based on Production Telemetry Data
...
These P0 fixes represent the highest-impact improvements we can make to n8n-harness-mcp based on real production telemetry data. By implementing all three fixes in v2.15.0, we will:
