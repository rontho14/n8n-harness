...
- Webhook workflows created on `https://n8n-test.(removed in harness fork)`
...
- n8n-harness-mcp-tester validation: All tools tested and working correctly in production
...
N8N_TEST_WEBHOOK_GET_URL=https://n8n-test.(removed in harness fork)/webhook/mcp-test-get
N8N_TEST_WEBHOOK_POST_URL=https://n8n-test.(removed in harness fork)/webhook/mcp-test-post
N8N_TEST_WEBHOOK_PUT_URL=https://n8n-test.(removed in harness fork)/webhook/mcp-test-put
N8N_TEST_WEBHOOK_DELETE_URL=https://n8n-test.(removed in harness fork)/webhook/mcp-test-delete
...
- `N8N_URL`: n8n instance URL (e.g., `https://n8n-test.(removed in harness fork)`)
...
1. ✅ Set up cloud n8n instance: `https://n8n-test.(removed in harness fork)`
...
**Lesson Learned**: Always test the layer closest to the user/consumer. For n8n-harness-mcp, that's the MCP handler layer.
